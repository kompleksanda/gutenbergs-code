...
def call():
        ...
        for i in range(10):
                ...
                #alt(-1, action=-1)
                #pron_w(2, action=1)
                pron_ws(use_match_ending=True)
                #pron_d(action=0, ml=2, me=0, mt="v", consonants=None)
...
def pron_ws(use_match_ending=True):
        ...
        #dire = "C:\\Users\\pc\\Desktop\\moby\\rim\\match\\pron_ws\\"+t
...
def pron_w(limit=1, action=1):
        ...
        if repos.reverse_all_pron: t+='_REV'
        if repos.silent == all_cons: t+='_SIL-CONS'
        #dire = "C:\\Users\\pc\\Desktop\\moby\\rim\\match\\"+word+t+".txt"
...
def alt(limit=-40, action=1):
        ...
        word = input("Enter word: ").strip().lower()
        t = word.replace(' ','-')
        #dire = "C:\\Users\\pc\\Desktop\\moby\\rim\\alt\\"+t+".txt"
...
def cons_m(action=-1, cc=1, ce =0, repeatables=[], anywhere=False, only_sound=False):
        ...
        if repos.reverse_all_pron: t+='_REV'
        if repos.silent == all_cons: t+='_SIL-CONS'
        #dire = "C:\\Users\\pc\\Desktop\\moby\\rim\\conso_m\\"+t1+t+".txt"
...
def pron_d(action=-1, ml=1, me=1, sy=0, se=0, mt="v", cmt="exactly", consonants=None):
        ...
        if repos.reverse_all_pron: t+='_REV'
        if repos.silent == all_cons: t+='_SIL-CONS'
        #dire = "C:\\Users\\pc\\Desktop\\moby\\rim\\match\\pron_d\\"+t1+t+".txt"
...
def altmatch(action=-1,level=1,levelexact=1, columns=3):
        ...
        if repos.reverse_all_pron: t+='_REV'
        if repos.silent == all_cons: t+='_SIL-CONS'
        #dire = "C:\\Users\\pc\\Desktop\\moby\\rim\\alt_match\\"+t1+t+".txt"
...
def sta_ma(action = -1, lent = 1, rep_times = 1, exa=1, anyw=False, only_s=False, repeatable=[], columns=3):
        ...
        if repos.reverse_all_pron: t+='_REV'
        if repos.silent == all_cons: t+='_SIL-CONS'
        #dire = "C:\\Users\\pc\\Desktop\\moby\\rim\\match\\"+word+t+"_REV.txt"
