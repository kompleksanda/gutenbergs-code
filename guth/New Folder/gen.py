...
def pos(time=10, action = 1):
        ...
        #dire = "C:\\Users\\pc\\Desktop\\moby\\rim\\word\\pos\\"+f
...
def me(time=10, action = 1):
        ...
        sentence = input("Enter words: ").lower()
        f = sentence.replace(' ','-')+".txt"
        #dire = "C:\\Users\\pc\\Desktop\\moby\\rim\\word\\match\\"+f
...
def at2(time=10, action = 1):
        ...
        sentence = input("Enter words: ").lower()
        f = sentence.replace(' ','-')+".txt"
        #dire = "C:\\Users\\pc\\Desktop\\moby\\rim\\word\\alt\\"+f
...
def stre(time=10, action = 1):
        ...
        sentence = input("Enter words: ").lower()
        f = sentence.replace(' ','-')+".txt"
        #dire = "C:\\Users\\pc\\Desktop\\moby\\rim\\word\\stress\\"+f
...
def vowe(action=2):
        ...
        fil2 = pro.replace(' ','-')
        #fil2 = 'C:\\Users\\pc\\Desktop\\moby\\rim\\word\\vowel\\'+fil2+'.txt'
...
def scale(length=3, times=100, action=2):
        #fil = 'C:\\Users\\pc\\Desktop\\moby\\rim\\scale\\'
...
def vowel_match(times=1000, action=2):
                repos.activate("pron")
                #fil = 'C:\\Users\\pc\\Desktop\\moby\\rim\\vowel_match\\'
